...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DH7M3u3R.mjs");
...
const manifest = { "336f879870c55ee2129c779d5f5975293e870c93730cc9c3d4268eaa589130d0": {
  ...
  importer: () => import("./barcode-fn-CEnPWN29.mjs")
  ...
  importer: () => import("./employee-fn-C6PyCmNT.mjs")
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-DBSpapjr.mjs").then(function(n) {
        return n.r;
      }).then((n) => n.r);
    }
    if (startEntry === null) {
