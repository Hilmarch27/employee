...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-w9zmFZr_.mjs");
...
const manifest = { "336f879870c55ee2129c779d5f5975293e870c93730cc9c3d4268eaa589130d0": {
  ...
  importer: () => import("./barcode-fn-D2sQUeXL.mjs")
  ...
  importer: () => import("./barcode-fn-D2sQUeXL.mjs")
}, "bdce5e45ae836926e7e85a5c47cdc7f11198570ab5e8029e62f8dbafb181032b": {
  functionName: "getPreviewHaircut_createServerFn_handler",
  importer: () => import("./barcode-fn-D2sQUeXL.mjs")
}, "be412f3b3e6ca295950e4fdcee9704a5fe5550e74a70796c87282f6a2167eadb": {
  functionName: "createEmployee_createServerFn_handler",
  importer: () => import("./employee-fn-la3_qZ4I.mjs")
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-PksdRzJZ.mjs").then(function(n) {
        return n.r;
      }).then((n) => n.r);
    }
    if (startEntry === null) {
